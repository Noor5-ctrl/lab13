terraform {
  backend "s3" {
    bucket       = "myapp-s3-bucket-demo-noor-lab13" 
...
# --- Task 7: Dynamic IAM Users from CSV ---
...
# Add all CSV users to developers group
...
# Create login profiles for all CSV users
...
# Create access keys for all CSV users
